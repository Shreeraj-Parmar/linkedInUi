...
const PremiumView = () => {
    ...
    const pricingData = [
        {
            ...
            getIn: [
                ...
                {
                    rightIcon: false,
                    description: "Unlimited company Create",
                },
                {
                    rightIcon: false,
                    description: "Unlimited Job Post",
                },
            ],
        },
        {
        ...
        },
        {
            ...
            getIn: [
                {
                    rightIcon: true,
                    description: "All features of Professional",
                },
                {
                    rightIcon: true,
                    description: "Access API integrations",
                },
                {
                    rightIcon: true,
                    description: "Unlimited company Create",
    ...
    const handleCheckoutSeesionForSubscription = async (data) => {
        ...
        let resOne = await checkAccountStatus();
        console.log(resOne);
        ...
        } else if (resOne.status === 201) {
            setSnak({
                type: "error",
                text: `${resOne.data.message}`,
            });
