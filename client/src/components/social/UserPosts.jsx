...
const UserPosts = ({ userData }) => {
  ...
  const limit = 10; // Number of notifications to load at a time
  ...
  return (
    <div
      ...
      className='all-posts border border-red-500 min-w-[100%] min-h-[700px] max-h-[700px] flex-row overflow-auto'
    >
      {allPost && allPost.length > 0
              ...
              <div className='flex justify-center' key={post._id}>
                ...
                >
                  <div className='post-des flex    w-[100%] space-x-2'>
                    <img
                      src={
                        (post.user && post.user.profilePicture) || "/blank.png"
                      }
                    ...
                    post.user._id !== currUserData._id ? (
                      <div className='follow-btn p-2 relative lg:left-[16rem]'>
                        ...
                        >
                          {followStatus[post && post.user && post.user._id]
                            ? "Folllowing"
                            : "+ Follow"}
                        </button>
                      </div>
        ...
        : "No post here"}
      {allPost.length === 0 &&
        "No post here, please follow someone to see their posts"}
    </div>
  );
};
